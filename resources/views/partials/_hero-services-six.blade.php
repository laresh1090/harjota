<x-hero-one
    title="Consultation - Business Development and Optimization"
    background="i/ss.jpg"
    :breadcrumbs="[
        ['url' => route('home'), 'title' => 'Home'],
        ['url' => route('about'), 'title' => 'Business Development and Optimization']
    ]"
/>
                        ...
                        <x-blog-post
                            :sections="[
                                ...
                                [
                                    ...
                                    'content' => '1. Business Analysis: We conduct comprehensive analyses to identify areas for improvement.<br>
2. Strategy Development: Our team develops customized strategies to drive business growth.<br>
3. Process Optimization: We streamline processes to enhance efficiency.<br>
4. Performance Metrics: Our team establishes key performance indicators (KPIs) to track progress.
'
                                ],
                                [
                                    'title' => 'Benefits',
                                    'content' => '1. Increased Efficiency: Our strategies optimize business operations.<br>
2. Improved Profitability: We help businesses reduce costs and increase revenue.<br>
3. Enhanced Decision Making: Our team provides data-driven insights.<br>
